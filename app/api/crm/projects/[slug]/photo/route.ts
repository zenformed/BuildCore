...
import { resolveMemberAccessibleProjectIdBySlug } from '@/infrastructure/crm/server/crmMemberProjectVisibilityService';
...
export async function GET(
  ...
  try {
    ...
    const canAccess = await resolveMemberAccessibleProjectIdBySlug(
