/**
 * DELETE /api/crm/projects/[slug]/budget-entries/[entryId]/documents/[documentId]
 */

import { NextRequest, NextResponse } from 'next/server';
import { requireCrmApiAuth } from '@/infrastructure/crm/server/crmApiRouteAuth';
import { crmDocumentErrorResponse } from '@/infrastructure/crm/server/crmDocumentRouteErrors';
import { deleteBudgetEntryDocumentForOrg } from '@/infrastructure/crm/server/crmBudgetEntryDocumentService';
...
export async function DELETE(
  ...
  try {
    await deleteBudgetEntryDocumentForOrg(
