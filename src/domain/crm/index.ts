...
export {
  ...
  CRM_LEGACY_INACTIVE_REASON_VALUES,
  CRM_LEGACY_SUBPROJECT_STATUS_VALUES,
  // Deprecated aliases (Phase 0–5)
  ...
  getCrmLegacyInactiveReasonLabel,
  ...
  type CrmLegacyInactiveReasonOption,
  type CrmLegacySubprojectStatus,
