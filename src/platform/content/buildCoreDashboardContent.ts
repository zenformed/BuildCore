...
const buildCoreDashboardContentSource = {
  ...
  projectDetail: {
    ...
    markCompleteIncompleteTasksTitle: 'Incomplete workflow tasks',
    markCompleteIncompleteTasksCancel: 'Cancel',
    markCompleteIncompleteTasksConfirm: 'Complete Anyway',
    /** @deprecated Prefer markCompleteIncompleteTasks* */
    markCompleteBlockedTitle:
      'This §E5§ still has incomplete workflow tasks',
    markCompleteBlockedStagesHeading: 'Workflow stages:',
    markCompleteBlockedDismiss: 'Cancel',
    ...
    projectStatus: {
      ...
      lostReasonDialog: {
        ...
        singleMessage: (name: string): string =>
          `Select a loss reason for ${name}.`,
        bulkMessage: (count: number): string =>
          `Select a loss reason for ${count} §E8§.`,
        reasonLabel: 'Loss reason',
        reasonPlaceholder: 'Select a reason',
        customReasonLabel: 'Custom reason',
        reasonRequired: 'Loss reason is required.',
        customReasonRequired: 'Custom reason is required when Other is selected.',
        submit: 'Mark Lost',
        submitting: 'Marking Lost…',
        closeAriaLabel: 'Close mark lost dialog',
      },
    },
