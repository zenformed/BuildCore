...
/**
 * Photos list v1 — unsigned cursor + post-fetch ACL/search overscan.
 * Kept for rollout rollback while Photos list v2 is flagged off.
 */
...
export function CrmPhotosPageV1(): ReactElement {
  ...
  return (
    <div className={styles.pageShell} data-crm-photos-page data-crm-photos-list="v1">
      {toast ? (
        <DetailToast
          kind={toast.kind}
