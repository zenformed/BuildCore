...
export function WorkflowSettingsAlertsPanel(): ReactElement {
...
export function WorkflowSettingsStagesPanel(): ReactElement {
  const sectionCopy = content.workflowSettings.folderTabs;
...
export function WorkflowSettingsMobileSections(): ReactElement {
  return (
